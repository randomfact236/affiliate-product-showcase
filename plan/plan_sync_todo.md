...
Step 1 — 🔴 Step 1 — Setup
  ...
  1.2 Folder Structure — create folder structure and repository layout
    ...
    1.2.4 `/admin/meta-boxes` - Meta box components
    1.2.5 `/admin/settings` - Settings page components
    1.2.6 `/public` - Frontend classes and controllers
    1.2.7 `/public/assets` - Frontend CSS, JS, images
    1.2.8 `/public/components` - React/TS components
    1.2.9 `/public/partials` - Frontend view templates
    1.2.10 `/includes` - Core plugin logic
    1.2.11 `/includes/abstracts` - Abstract base classes
    1.2.12 `/includes/interfaces` - PHP interfaces
    1.2.13 `/includes/traits` - Reusable traits
    1.2.14 `/includes/services` - Business logic services
    1.2.15 `/includes/repositories` - Data access layer
    1.2.16 `/includes/models` - Data models
    1.2.17 `/includes/validators` - Input validation classes
    1.2.18 `/includes/sanitizers` - Input sanitization classes
    1.2.19 `/includes/formatters` - Output formatting classes
    1.2.20 `/includes/factories` - Object factory classes
    1.2.21 `/includes/exceptions` - Custom exception classes
    1.2.22 `/includes/helpers` - Helper functions
    1.2.23 `/includes/hooks` - WordPress hook handlers
    1.2.24 `/includes/rest-api` - REST API endpoints
    1.2.25 `/includes/cli` - WP-CLI commands
    1.2.26 `/assets` - Shared assets
    1.2.27 `/languages` - Translation files
    1.2.28 `/vendor` - Composer dependencies (production only)
    1.2.29 `/node_modules` - NPM dependencies (dev only)
    1.2.30 `/dist` - Compiled/bundled assets
    1.2.31 `/tests` - PHPUnit tests
    1.2.32 `/tests/unit` - Unit tests
    1.2.33 `/tests/integration` - Integration tests
    1.2.34 `/tests/fixtures` - Test fixtures
    1.2.35 `/tests/mocks` - Mock objects
    1.2.36 `/docs` - Documentation
