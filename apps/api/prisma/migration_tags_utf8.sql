...
-- CreateEnum
CREATE TYPE "ConversionStatus" AS ENUM ('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED', 'SKIPPED');
...
-- CreateIndex
CREATE INDEX "tags_is_active_sort_order_idx" ON "tags"("is_active", "sort_order");
...
-- CreateIndex
CREATE INDEX "media_is_converted_idx" ON "media"("is_converted");

-- CreateIndex
CREATE INDEX "media_conversion_status_idx" ON "media"("conversion_status");

-- CreateIndex
CREATE INDEX "media_created_at_idx" ON "media"("created_at");

-- CreateIndex
CREATE INDEX "media_usage_product_id_idx" ON "media_usage"("product_id");

-- CreateIndex
CREATE INDEX "media_usage_media_id_idx" ON "media_usage"("media_id");

-- CreateIndex
CREATE UNIQUE INDEX "media_usage_media_id_product_id_key" ON "media_usage"("media_id", "product_id");
...
-- AddForeignKey
ALTER TABLE "media_usage" ADD CONSTRAINT "media_usage_media_id_fkey" FOREIGN KEY ("media_id") REFERENCES "media"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "media_usage" ADD CONSTRAINT "media_usage_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "product_images" ADD CONSTRAINT "product_images_media_id_fkey" FOREIGN KEY ("media_id") REFERENCES "media"("id") ON DELETE SET NULL ON UPDATE CASCADE;
